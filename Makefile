...
TEST_PROJECTS=examples/simple_stencil examples/strides examples/simple_openACC examples/poisson2d_fem_iterative examples/midaco_solver examples/diffusion3d examples/particle
